...
public enum ArmorMaterialMcku implements ArmorMaterial {
    ...
    BANDANA_INDONESIA("bandana_indonesia", 78,Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266652_) -> {
        p_266652_.put(ArmorItem.Type.HELMET, 3);
    }), 10, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
        return Ingredient.of(ItemInit.RED_LEATHER.get(), ItemInit.WHITE_LEATHER.get(), ItemInit.BANDANA_INDONESIA.get());
    });
    ...
    private ArmorMaterialMcku(String p_268171_, int p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier<Ingredient> p_268256_) {
        this.name = p_268171_;
